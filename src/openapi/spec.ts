    ...
    schemas: {
      ...
      SellerSnapshot: {
        ...
        properties: {
          ...
          completion_rate:    { type: "integer", nullable: true, description: "Percent of terminal trades completed. Null when none yet." },
          avg_response_minutes: { type: "integer", nullable: true, description: "Average reply time in minutes. Null until the seller has replied." },
